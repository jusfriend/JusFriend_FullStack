...
@section('content')
    ...
    <section class="flex items-center hero">
      ...
      >
      <div style="background-color: black; width:80vw; display:flex; justify-content:center">
        <h1>cob</h1>
      </div>
      </div> --}}
        <div class="heroJus">
          <img class="img-jus" src="/frontend/images/content/jushero.png" alt="">
        </div>
    ...
    <section class="flex flex-col py-16">
      <div class="container mx-auto mb-4">
        <div class="flex justify-center text-center mb-6">
          <h3 class="text-2xl capitalize font-semibold" style="color: #404040">
            Produk di Juice.Friend
          </h3>
        </div>
        <a href="#" class="flex justify-center mb-4" style="">
          Lihat lebih banyak <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path d="M7 7h8.586L5.293 17.293l1.414 1.414L17 8.414V17h2V5H7v2z"/></svg>
        </a>
      </div>
          ...
          <div class="px-4 relative card group">
              <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                  ...
                  <div class="relative w-full h-full">
                      ...
                      <img src="{{ $categories->galleri()->exists() ? Storage::url($categories->galleri->first()->url) : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mN88B8AAsUB4ZtvXtIAAAAASUVORK5CYII=' }}" alt="" class="w-full h-full object-cover object-center" />
                      <!-- Overlay for text -->
                      <div class="absolute bottom-0 left-0 right-0 text-center bg-white bg-opacity-50 p-4">
                          <h5 class="text-lg font-semibold">{{ $categories->name }}</h5>
                      </div>
                  </div>
  
                  <!-- Link to details -->
                  <a href="{{ route('categories-details', $categories->slug) }}" class="stretched-link"></a>
              </div>
          </div>
          @endforeach
